...
public:
  ...
  DWORD npid[MAX_PATH];
  bool EnumWindow(HWND parent, const wchar_t *title, const wchar_t *class_name,
                  LONG filter, wchar_t *retstring,
                  const wchar_t *process_name = NULL);
  bool EnumWindowSuper(wchar_t *spec1, LONG flag1, LONG type1, wchar_t *spec2,
                       LONG flag2, LONG type2, LONG sort,
  ...
  long FindWindowEx(long parent, const wchar_t *class_name,
                    const wchar_t *title);
  bool FindWindowByProcess(const wchar_t *class_name, const wchar_t *titl,
                           LONG &rethwnd, const wchar_t *process_name = NULL,
                           DWORD Pid = 0);
...
private:
  DWORD FindChildWnd(HWND hchile, const wchar_t *title,
                     const wchar_t *classname, wchar_t *retstring,
                     bool isGW_OWNER = false, bool isVisible = false,
                     const wchar_t *process_name = NULL);

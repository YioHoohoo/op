...
struct CD3DX12_SUBRESOURCE_RANGE_UINT64
  ...
  CD3DX12_SUBRESOURCE_RANGE_UINT64(UINT subresource, UINT64 begin,
                                   UINT64 end) noexcept {
    Subresource = subresource;
    Range.Begin = begin;
    Range.End = end;
...
struct CD3DX12_SHADER_BYTECODE : public D3D12_SHADER_BYTECODE {
  ...
  CD3DX12_SHADER_BYTECODE(const void *_pShaderBytecode,
...
struct CD3DX12_TILED_RESOURCE_COORDINATE
  ...
  CD3DX12_TILED_RESOURCE_COORDINATE(UINT x, UINT y, UINT z,
...
struct CD3DX12_TILE_REGION_SIZE : public D3D12_TILE_REGION_SIZE {
  ...
  CD3DX12_TILE_REGION_SIZE(UINT numTiles, BOOL useBox, UINT width,
                           UINT16 height, UINT16 depth) noexcept {
    NumTiles = numTiles;
    UseBox = useBox;
    Width = width;
    Height = height;
...
struct CD3DX12_SUBRESOURCE_FOOTPRINT : public D3D12_SUBRESOURCE_FOOTPRINT {
  ...
  CD3DX12_SUBRESOURCE_FOOTPRINT(DXGI_FORMAT format, UINT width, UINT height,
                                UINT depth, UINT rowPitch) noexcept {
    Format = format;
    Width = width;
    Height = height;
    Depth = depth;
...
public:
  ...
  operator const D3D12_DXIL_SUBOBJECT_TO_EXPORTS_ASSOCIATION &()
      const noexcept {
    return m_Desc;
  }
